...
public class PurePursuitPath {
    ...
    public ArrayList<IntersectionPoint> findIntersections(Vector robotPosition, double lookaheadRadius){
    ...
    public IntersectionPoint findApproachPoint(Vector robotPosition, double lookaheadRadius){
    ...
    public double distanceAlongPath(Vector robotPosition, IntersectionPoint approachPoint){
    ...
    public IntersectionPoint closestWaypoint(Vector robotPosition){
